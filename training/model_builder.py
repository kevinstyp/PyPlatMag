...
def build_network_goce_pinn(input_shape, batch_size, #init_raw=None, init_sa=None, init_bc=None, init_tq=None,
                            number_of_bisa_neurons=0, trainable_pinn=True):
    print("input_shape in build-method: ", input_shape)
    ...
    # model = CustomModel(inputs=inputs_list, outputs=outputs)
